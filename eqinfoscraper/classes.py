import re
from eqinfoscraper.data_processor import process_data as pd
...
class EarthquakeList:
    def __init__(self, URL, cutoff_date=None):
        ...
        self._eq_list = pd.get_earthquake_entries(URL, self._source, cutoff_date)
        self._eq_stats = pd.get_stats(self._source, self._eq_list)
